...
func show_cycle_help_4():
   GlobalFunctions.show_warning(self, "", "If you are done with the 'term' entirely (answered every required day), it will be marked as 'known' and will never be asked again by the cycle system.")
   pass
